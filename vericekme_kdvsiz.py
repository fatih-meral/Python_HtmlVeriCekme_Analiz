        ...
        if response.status_code == 200:
            ...
            for div in divs:
                try:
                    ...
                    #####dolarkur#######
                    alis_fiyat="Bilinmiyor"
                    
                    for dd in djs:
                        if dd["urun_kod"]==number.text.strip():
                            print(dd["alis_fiyat"])
                            alis_fiyat=dd["alis_fiyat"]
                    ...
                    json_body = [
                        {
                            ...
                            "fields": {
                                "fiyat": fiyat,
                                "alis_fiyat": float(float(alis_fiyat)*dolar)## dolar kuru ile çarpılımış gidecek güncel
                            }
                        }
                    ]
